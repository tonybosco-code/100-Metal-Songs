...
export default function HeroLatest({ ep }: { ep: EpisodeDoc }) {
  ...
  const listenHref = ep.audioUrl ?? ep.links?.spotify ?? ep.links?.apple ?? ep.links?.rss ?? null;
  const watchHref = ep.links?.youtube ?? null;
  ...
  return (
    <section aria-label="Latest Episode">
      <div
        className="
      ...
      >
        ...
        {/* TEXT SIDE — padded on the right so the art never overlaps */}
        <div className="mt-3 pr-28 sm:pr-36 md:pr-40 lg:pr-44">
          ...
          {plain ? <p className="mt-4 text-zinc-300 line-clamp-6">{plain}</p> : null}
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            {watchHref && (
              ...
              >
                ...
                <svg viewBox="0 0 24 24" className="mr-2 h-4 w-4" aria-hidden="true">
                  <path fill="currentColor" d="M4 6h16a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Zm2 11h12v2H6v-2Z" />
                </svg>
                Watch
              </a>
            )}
            {listenHref && (
              ...
              >
                {/* headphones icon */}
                <svg viewBox="0 0 24 24" className="mr-2 h-4 w-4" aria-hidden="true">
                  <path fill="currentColor" d="M12 3a7 7 0 0 0-7 7v6a2 2 0 0 0 2 2h1v-6H7a5 5 0 0 1 10 0h-1v6h1a2 2 0 0 0 2-2v-6a7 7 0 0 0-7-7Z" />
                </svg>
                Listen
              </a>
            )}
        ...
        {/* COVER ART — always pinned top-right on all breakpoints */}
        <div className="absolute right-4 top-4">
          <div className="relative h-20 w-20 sm:h-24 sm:w-24 md:h-28 md:w-28 lg:h-32 lg:w-32 overflow-hidden rounded-xl ring-1 ring-white/10">
            <Image
              src={art}
              alt={`${title} cover art`}
              fill
